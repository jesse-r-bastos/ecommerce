									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<div style="width: 300px; border: solid 1px blue;">
												<p id="billing_state_field" class="form-row form-row-first address-field validate-state"data-o_class="form-row form-row-first address-field validate-state"  >
													<input type="radio" checked="checked" id="method-pagseguro" name="payment-method" value="1" style="float: left; margin: 30px; border: solid 1px;" >
											...
											<div id="payment">
												<div class="form-row place-order">
													<input type="submit" data-value="Place order" value="Continuar" id="place_order" name="woocommerce_checkout_place_order" class="button alt" style="margin: 10px 0px 10px 90px;">
												<div class="clear"></div>
											</div>
										</div>
									</div>
