            ...
            <div class="col-md-12">
                <div class="product-pagination text-center">
                    <nav>
                        ...
                        <li style="color:blue;font-size: 18px;font-family:Arial Black"><a href="<?php echo htmlspecialchars( $value1["link"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["page"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
                        <?php } ?>
