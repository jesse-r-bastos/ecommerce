  	...
  	<div class="col-md-12">
  		<div class="box box-primary">
            ...
            <div class="box-header">
              <a href="/admin/users/create" class="btn btn-success fa fa-user" >  Cadastrar Usuário</a>
              <div class="box-tools">
              ...
              <table class="table table-striped"  >
                <thead style="background-color: #CCC;">
                  <tr style="color:blue;">
                    ...
                    <th style="width: 240px"> __________ Atualização ________</th>                    
                  </tr>
                </thead>
                <tbody style="background-color: #C2D6E7;">
                  ...
                  <tr>
                    ...
                    <td >
                      ...
                      <a href="/admin/users/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/password" class="btn btn-default btn-xs"><i class="fa fa-unlock"></i ><small> Alterar Senha</small></a>
            ...
            <div class="box-footer clearfix">
              <ul class="pagination pagination-sm no-margin pull-right"> 
                ...
                <li><a style="font-family: Arial Black;" href="<?php echo htmlspecialchars( $value1["href"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["text"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a> </li>
                <?php } ?>
              </ul>
            </div>
          </div>
