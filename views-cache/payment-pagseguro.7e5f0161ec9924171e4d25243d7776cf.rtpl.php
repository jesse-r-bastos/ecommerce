<?php if(!class_exists('Rain\Tpl')){exit;}?><!-- Declaração do formulário 
   target original do form > target="pagseguro" -->
<form method="post" action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
          
        <!-- Campos obrigatórios -->  
        <input name="receiverEmail" type="hidden" value="jesse.r.bastos@gmail.com">  
...
<!-- Eliminando Botão para que possamos enviar automático
